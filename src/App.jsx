...
const CONTACTS = [
  { label: "Email", value: "agaputra62@gmail.com", href: "mailto:agaputra62@gmail.com", color: COLORS.accent, icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: 22, height: 22 }}><rect x="2" y="4" width="20" height="16" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></svg> },
      ...
      <Container>
        ...
        <div style={{ maxWidth: 700, margin: "48px auto 0", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <a href="mailto:agaputra62@gmail.com" className="btn-outline"
